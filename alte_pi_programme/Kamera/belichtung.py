...
# Zielordner
SAVE_DIR = "/home/janne/Desktop/Masterprojekt/Kamera/Testbilder_belichtung"
...
def main():
    ...
    for gain in GAINS:
        for exp_us in EXPOSURE_TIMES_US:
            ...
            if SHOW_PREVIEW:
                overlay_text = f"Exp: {exp_us} µs  Gain: {gain:.2f}  ({idx}/{total})"
            ...
            # Datei schreiben
            fname = f"img_exp{exp_us}_gain{gain:.2f}_idx{idx:02d}.jpg"
